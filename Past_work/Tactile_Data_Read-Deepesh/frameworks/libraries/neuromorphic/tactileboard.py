...
from ..general.serialhandler import SerialHandler #serial handler for communication
from ..general.threadhandler import ThreadHandler #thread handler for data acquisition
from ..general.dataprocessing import * #moving average
#-------------------------------------------------------------------------------
class TBCONSTS:
    #---------------------------------------------------------------------------
    #Hardware parameters
